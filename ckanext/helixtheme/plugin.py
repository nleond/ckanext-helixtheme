...
class HelixthemePlugin(plugins.SingletonPlugin):
    ...
    def before_map(self, mapper):
        mapper.connect('dataset_apis', '/dataset/developers/{id}', controller= 'ckanext.helixtheme.controllers.package:PackageController', action='package_apis')
        #mapper.connect('dataset_contact_form', '/dataset/contact/{id}', controller= 'ckanext.helixtheme.controllers.contact:Controller', action='contact_form')
